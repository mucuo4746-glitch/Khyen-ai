...
const server = http.createServer((req, res) => {
    if (req.url === '/' || req.url === '/index.html') {
        ...
        // 旗舰版 UI：升级了色彩、Markdown 支持、气泡流和藏文对齐字体序列
        ...
        <style>
            /* 修正核心：增强字体序列，专门支持 complex script rendering (如藏文) */
            body { font-family: "Noto Serif SC", "Noto Serif Tibetan", "Microsoft YaHei UI", serif; text-rendering: optimizeLegibility; background: #fdfbf7; margin: 0; display: flex; flex-direction: column; height: 100vh; color: #3d2b1f; }
