...
<style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .m{max-width:88%;padding:14px 18px;border-radius:16px;line-height:1.8;overflow-wrap:break-word}
    ...
    #t{flex:1;height:44px;border:1px solid #ddd;border-radius:12px;padding:10px 14px;font-size:15px;outline:none;resize:none;background:#fcfaf7;font-family:inherit}
